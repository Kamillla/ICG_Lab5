...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pGround->LoadMesh("C:/SRC/Content/quad.obj")) {
            return false;
        }
        
        if (!m_billboardList.Init("C:/SRC/Content/monster_hellknight.png")) {
            return false;
        }
               
        m_pTexture = new Texture(GL_TEXTURE_2D, "C:/SRC/Content/bricks.jpg");
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "C:/SRC/Content/normal_map.jpg");
